        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FacilityId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilityPatients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FacilityPatients_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacilityPatients_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FacilityId = table.Column<Guid>(type: "uuid", nullable: false),
                    FacilityPatientId = table.Column<Guid>(type: "uuid", nullable: false),
                    FacilityDoctorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdolescentHealths_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIRecommendations_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalComplaints = table.Column<string>(type: "text", nullable: true),
                    ...
                    SmokingStatus = table.Column<bool>(type: "boolean", nullable: true),
                    AlcoholConsumption = table.Column<bool>(type: "boolean", nullable: true),
                    InsufficientVegetableFruitIntake = table.Column<bool>(type: "boolean", nullable: true),
                    GeneralAppearance = table.Column<string>(type: "text", nullable: true),
                    ConsciousnessLevel = table.Column<int>(type: "integer", nullable: true),
                    BodyTemperature = table.Column<decimal>(type: "numeric", nullable: true),
                    RespiratoryRate = table.Column<int>(type: "integer", nullable: true),
                    PulseRate = table.Column<int>(type: "integer", nullable: true),
                    HeartRhythm = table.Column<int>(type: "integer", nullable: true),
                    ...
                    Height = table.Column<decimal>(type: "numeric", nullable: true),
                    HeightMeasurementMethod = table.Column<int>(type: "integer", nullable: true),
                    ...
                    BMIClassification = table.Column<string>(type: "text", nullable: true),
                    ...
                    HeadExamination = table.Column<string>(type: "text", nullable: true),
                    EyeExamination = table.Column<string>(type: "text", nullable: true),
                    EarExamination = table.Column<string>(type: "text", nullable: true),
                    NoseExamination = table.Column<string>(type: "text", nullable: true),
                    MouthExamination = table.Column<string>(type: "text", nullable: true),
                    ThroatExamination = table.Column<string>(type: "text", nullable: true),
                    LungExamination = table.Column<string>(type: "text", nullable: true),
                    CardiovascularExamination = table.Column<string>(type: "text", nullable: true),
                    ChestAxillaExamination = table.Column<string>(type: "text", nullable: true),
                    AbdominalExamination = table.Column<string>(type: "text", nullable: true),
                    UpperExtremityExamination = table.Column<string>(type: "text", nullable: true),
                    LowerExtremityExamination = table.Column<string>(type: "text", nullable: true),
                    GenitaliaExamination = table.Column<string>(type: "text", nullable: true),
                    SkinExamination = table.Column<string>(type: "text", nullable: true),
                    NailExamination = table.Column<string>(type: "text", nullable: true),
                    NeckExamination = table.Column<string>(type: "text", nullable: true),
                    NeurologicalExamination = table.Column<string>(type: "text", nullable: true),
                    TriageLevel = table.Column<int>(type: "integer", nullable: true),
                    BodyAnatomyFindings = table.Column<string>(type: "text", nullable: true),
                    ClinicalNotes = table.Column<string>(type: "text", nullable: true),
                    AdditionalFindings = table.Column<string>(type: "text", nullable: true),
                    ObservationNotes = table.Column<string>(type: "text", nullable: true),
                    AdditionalRemarks = table.Column<string>(type: "text", nullable: true),
                    BiopsychosocialAssessment = table.Column<string>(type: "text", nullable: true),
                    SubjectiveAssessment = table.Column<string>(type: "text", nullable: true),
                    ObjectiveFindings = table.Column<string>(type: "text", nullable: true),
                    Assessment = table.Column<string>(type: "text", nullable: true),
                    PlanOfCare = table.Column<string>(type: "text", nullable: true),
                    NursingCareType = table.Column<int>(type: "integer", nullable: true),
                    NursingCareDescription = table.Column<string>(type: "text", nullable: true),
                    NursingInterventions = table.Column<string>(type: "text", nullable: true),
                    PatientEducation = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Anamnesis_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScientificDescription = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyPlannings_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HIVCounselings_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Immunizations_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LaboratoriumTests_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaternalChildHealths_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Odontograms_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_STIs_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdolescentHealths_AppointmentId",
                table: "AdolescentHealths",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AIRecommendations_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityPatients_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityPatients_PatientId",
                table: "FacilityPatients",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyPlannings_AppointmentId",
                table: "FamilyPlannings",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_HIVCounselings_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaboratoriumTests_AppointmentId",
                table: "LaboratoriumTests",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_MaternalChildHealths_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Odontograms_AppointmentId",
                table: "Odontograms",
                column: "AppointmentId");
